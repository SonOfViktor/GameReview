...
<body>
    ...
    <section class="user mb-5">
        <div class="container">
            <div class="row">
                ...
                <div class="col-2 align-self-center">
                    <div class="vstack gap-5">
                        <a class="btn btn-primary lh-sm mx-3"
                           href="${pageContext.request.contextPath}/controller?command=to_user_editor_page" role="button">
                ...
                <div class="col-2 align-self-center">
                    <div class="vstack gap-5">
                        <a class="btn btn-success lh-sm mx-3" href="#" role="button">
    ...
    <section class="my-3">
        <div class="container">
            <div class="row">
                <h4><fmt:message key="score_distribution"/>к:</h4>
                <div class="col-2">
