    ...
    <body>
        ...
        <c:if test="${login_message_error}">
            ...
            <div class="alert alert-danger d-flex align-items-center" role="alert">
                ...
                <div>
<%--                    <c:choose>--%>
<%--                        <c:when test="${login_data_error}">--%>
<%--                            <fmt:message key="login.data.error"/>--%>
<%--                            <c:remove var="login_data_error" scope="session"/>--%>
<%--                        </c:when>--%>
<%--                        <c:otherwise>--%>
...
<%--                    </c:choose>--%>
            ...
            <c:remove var="login_message_error" scope="session"/>
        </c:if>
