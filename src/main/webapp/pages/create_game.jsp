...
<div class="container mt-5">
    <form class="row g-3 needs-validation" novalidate method="post" action="upload_image" enctype="multipart/form-data">
        ...
        <!-- <div class="w-100"></div>                   Это скрипт для ютуба
        <div class="col-5">
          <iframe width="600" height="500" src="https://www.youtube.com/embed/qPNiIeKMHyg" title="YouTube video player" frameborder="0"
